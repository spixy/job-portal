...
namespace Infrastructure.Query
{
    public class EfQuery<TEntity> : QueryBase<TEntity> where TEntity : class, IEntity, new()
    {
        ...
        private IQueryable<TEntity> UseSortCriteria(IQueryable<TEntity> queryable)
        {
            ...
            return (IQueryable<TEntity>)typeof(EfQuery<TEntity>)
        ...
        private IQueryable<TEntity> UseFilterCriteria(IQueryable<TEntity> queryable)
        {
            ...
            var lambdaExpression = Expression.Lambda<Func<TEntity, bool>>(bodyExpression, this.ParameterExpression);
        ...
        private Expression BuildBinaryExpression(IPredicate predicate)
        {
            ...
            return simplePredicate.GetExpression(this.ParameterExpression);
        }
    }
}
